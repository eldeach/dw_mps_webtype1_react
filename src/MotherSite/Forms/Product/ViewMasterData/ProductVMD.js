...
// ======================================================================================== [Import Component] js
// its lang Object
import productVMDLang from './productVMDLang'
...
function ProductVMD (props) {
    ...
    useEffect(() =>{
        handlePageTitle(productVMDLang.formTitle[cookies.load('site-lang')])
    ...
    return (
        <div id = 'userView' style ={{ display : 'flex', flexDirection : 'column'}} >
            <div style ={{ width : '100wv', marginBottom : '6px', display : 'flex', flexDirection : 'row', justifyContent : 'center' }}>
                ...
                <div style={{ flexGrow : 1 }}/>
                <Button sx={{ ml:0, mt:0, mb:0, mr:1, p:0, height:'30px', fontSize:'16px'}} variant="contained" color = 'sys1' size="small" href='/addproduct'><LibraryAddIcon fontSize='inherit'/></Button>
            </div>
            <div>
                {
