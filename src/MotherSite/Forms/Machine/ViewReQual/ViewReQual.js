...
// ======================================================================================== [Import Component] js
// its lang Object
import viewReQualLang from './viewReQualLang'
...
function ViewReQual (props) {
    ...
    useEffect(() =>{
        handlePageTitle(viewReQualLang.formTitle[cookies.load('site-lang')])
