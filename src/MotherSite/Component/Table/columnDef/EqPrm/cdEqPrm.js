...
// ======================================================================================== [Import Component] js
import VerifiedPrm from "../../Button/CellValuePopUp/VerifiedPrm/VerifiedPrm";
import PrmValueLabel from '../../Label/PrmValueLabel/PrmValueLabel'
// Component Object
...
const columnDef = [  // TanStack Table은 컬럼 사이즈가 20이 최소
    ...
    ),
    {
        ...
        header: <div style={{width:'80px', textAlign:'center'}}>{{ kor : '펼쳐보기', eng :'Spread to View'}[cookies.load('site-lang')]}</div>,
        cell: ({ row }) =>  (<VerifiedPrm oneItem = {row.original}/>)
    ...
    columnHelper.accessor( "prm_batchsize_vial_min_value",
        {
            header: prmCodeBook.prm_batchsize_vial.value.min_value,
            size: 120,
            enableColumnFilter: true,
            cell: renderValue => <PrmValueLabel prmValue = {renderValue.getValue()}/>
        }
    ),
    columnHelper.accessor( "prm_batchsize_vial_max_value",
        {
            header: prmCodeBook.prm_batchsize_vial.value.max_value,
            size: 120,
            enableColumnFilter: true,
            cell: renderValue => <PrmValueLabel prmValue = {renderValue.getValue()}/>
        }
    ),
    columnHelper.accessor( "prm_batchsize_syringe_min_value",
        {
            header: prmCodeBook.prm_batchsize_syringe.value.min_value,
            size: 120,
            enableColumnFilter: true,
            cell: renderValue => <PrmValueLabel prmValue = {renderValue.getValue()}/>
        }
    ),
    columnHelper.accessor( "prm_batchsize_syringe_max_value",
        {
            header: prmCodeBook.prm_batchsize_syringe.value.max_value,
            size: 120,
            enableColumnFilter: true,
            cell: renderValue => <PrmValueLabel prmValue = {renderValue.getValue()}/>
        }
