...
// ======================================================================================== [Import Component] js
import PgChkParamFlexwFlexrowTblHeader from './PgChkParamFlexwFlexrowTblHeader';

// ======================================================================================== [Import Component] CSS
import './PgChkParamFlexwFlexrowTbl.css'

function PgChkParamFlexwTbl(props) {
    ...
    const { getUrl, params, columns, tblWidth, numRow, setTableSelected } = props;
    ...
    return (
        <div className="page-chk-param-flexw-tbl" style={{ width: tblWidth }}>
            <div className='page-chk-param-flexw-tbl-ctrl'>
                <div style={{ display: 'flex', flexDirection: 'column', width: '490px' }}>
                    <div style={{ flexGrow: '1' }} />
                    <div style={{ fontSize: '12px', marginBottom: '3px' }}>
                        {
                            {
                                kor: `선택됨 : ${table.getSelectedRowModel().rows.length} 행`,
                                eng: `Selected : ${table.getSelectedRowModel().rows.length} Rows`
                ...
                <div style={{ display: 'flex', flexDirection: 'row', width: '490px' }}>
                    ...
                    <Pagination
                        ...
                        variant="outlined"
                        color="sys1" />
                    <IconButton size="small" edge="end" color="sys1" sx={{ ml: 0.5, mt: 0.5 }} onClick={() => getDbData()} >
                        <AutoModeIcon />
                    </IconButton>
                </div>
            </div>
            <div className="page-chk-param-flexw-tbl-box">
                <table>
                    <thead>
                        {
                                ...
                                <tr key={headerGroup.id} style={{ fontSize: '12px' }}>
                                    {
                                        headerGroup.headers.map(header => (
                                            <PgChkParamFlexwFlexrowTblHeader key={header.id} header={header} />
                                        ))
                                    }
                                </tr>
                            ))
...
export default PgChkParamFlexwTbl;