...
import PgParamTblHeader from './PgParamTblHeader';


// ======================================================================================== [Import Component] CSS
import './PgParamTbl.css'
...
function PageTable(props) {
    ...
    const { getUrl, params, columns } = props;
    ...
    return (
        <div className="page-param-tbl">
            <div className='page-param-tbl-ctrl'>
                ...
                <div style={{ display: 'flex', flexDirection: 'row', width: '490px' }}>
                    ...
                    <ExcelDownButton data={data} sheetName={getUrl.replace(`/`, "")} />
                </div>
            </div>
            <div className="page-param-tbl-box">
                <table>
                    <thead>
                        {
                                ...
                                <tr key={headerGroup.id} style={{ fontSize: '12px' }}>
                                    {
                                        headerGroup.headers.map(header => (
                                            <PgParamTblHeader key={header.id} header={header} />
                                        ))
                                    }
                                </tr>
                            ))
